...
function Step({ n, title, children }: { n: number; title: string; children: React.ReactNode }) {
  return (
    <div className="border-t border-border pt-6 first:border-t-0 first:pt-0 mt-6">
...
export function CateringPlannerForm({ onSuccess }: { onSuccess?: () => void }) {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        <h2 className="font-display text-3xl text-primary">Plan Your Feast</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          Tell us a little about your celebration and we will shape a menu around it.
        </p>
      </div>
      ...
      <Step n={3} title="Number of guests">
        <div className="flex items-center gap-4">
          ...
          <input
            ...
            className="w-24 sm:w-32 rounded-xl border border-border bg-secondary/40 px-4 py-3 text-center font-display text-xl text-primary focus:border-gold focus:outline-none"
          />
          <button
            type="button"
      ...
      <Step n={4} title="Event date">
        ...
        <input
          ...
          className="w-full rounded-xl border border-border bg-secondary/40 px-4 py-3 text-sm text-foreground focus:border-gold focus:outline-none"
        />
      </Step>
      ...
      <div className="border-t border-border pt-6 pb-6">
        ...
        <button
          ...
          className="mt-6 w-full rounded-full bg-gold px-8 py-3.5 text-sm font-medium text-primary transition-all duration-300 hover:-translate-y-0.5 hover:bg-gold-soft"
        >
